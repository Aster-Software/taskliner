...
import type { QueryInput, RouterType } from "~/../../../api/src/esorm/everything";
import type { RouterResultType } from "../../../../api/src/core/Router";

export const useGetMany = <Path extends RouteKey>(path: Path, input: QueryInput[]) => {
    const query = GetOrCreateQuery(path, input);

    return query
}

export const useGetOne = <Path extends RouteKey>(path: Path, input: string) => {}
